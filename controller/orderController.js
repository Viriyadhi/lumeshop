...
exports.create = (req, res) => {
    const newOrders = {
        jumlah: req.fields.jumlah,
        jumlah_harga: req.fields.jumlah_harga,
        cart_id: req.fields.cart_id,
        user_id: req.fields.user_id,
        coins_value: req.fields.coins_value,
        shipping_cargos_id: req.fields.shipping_cargos_id,
        addresses_id: req.fields.addresses_id,
        jenis_pembayaran_id: req.fields.jenis_pembayaran_id,
        resi_pengiriman: req.fields.resi_pengiriman,
        order_promo_id: req.fields.order_promo_id,
    };
    if (!newOrders.jumlah ||
